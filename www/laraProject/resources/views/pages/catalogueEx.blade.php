                    ...
                    @if($annuncio->status!=0)
                        <div class="col-sm-6 col-md-4">
                            <div class="box">
                                <a href>
                                    <div class="img-box">
                                        <img src="./immaginiAnnunci/prova.png" height="300px" class="disp">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <a href>
                                        <h4>ann.city, ann.state</h4>
                                    </a>
                                    <h6>€'canone'</h6>
                                    <label>Da 'inizio data' a 'fine data</label>
                                    <p>
                                        'annuncio desc'
                                    </p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="box">
                                <a href class="disabled">
                                    <div class="img-box">
                                        <img src="./immaginiAnnunci/prova.png" height="300px" class="no_disp">
                                    </div>
                                </a>
                                <div class="detail-box">
                                    <a href class="disabled">
                                    ...
                                    <h6>€"Costo canone"</h6>
                                    <label>Da 'Data start' a 'data fine'</label>
                                    <p>
