                    ...
                    <div class="tab-content">
                                            ...
                                            <div class="carousel-inner">
                                                    ...
                                                    <div class="container ">
                                                        <div class="col-md-10">
                                                            @if($annuncio[0]->mainImg!=null)
                                                                <img id="img"
                                                                     src="{{asset('/immaginiAnnunci/'.$annuncio[0]->mainImg) }}"
                                                ...
                                                @foreach($photo as $ph)
                                                    <div class="carousel-item">
                                                        <div class="container ">
                                                            <div class="col-md-10">
                                                                <img src="{{asset('/immaginiAnnunci/'.$ph->url)}}"
                                                                     height="300px" width="450px">
                                                            </div>
                                                        </div>
                                                    </div>
                      ...
                      {{ $annuncio[0]->descrizione}}
                                    ...
                                    <div class="specifiche"><!-- Specifiche -->
                                        ...
                                        <span
                                            class="span4">&dash; Genere locatario: {{$annuncio[0]->genere_locatario}}</span><br>
                                        @if($annuncio[0]->is_camera==1)
                                            <span
                                                class="span4">&dash; Posti letto nella camera: {{$annuncio[0]->posti_camera}}</span>
                                            <br>
                                            <span
                                                class="span4">&dash; disponiblita_angolo_studio: {{$annuncio[0]->disponilita_angolo_studio}}</span>
                                            <br>
                                        @else
                                            <span
                                                class="span4">&dash; Numero di camere: {{$annuncio[0]->numero_camere}}</span>
                                            <br>
                                        @endif
                                        <span
                                            class="span4">&dash; Posti letto totali: {{$annuncio[0]->posti_letto_totali}}</span><br>
                                    ...
                                    <div class="prezzo">
                                        <h4>Prezzo: <h2>{{$annuncio[0]->canone_affitto}}€</h2></h4>
                                        <br>
                                    </div>
                                    <br>
                        ...
                        SERVIZI DISPONIBILI
                                        ...
                                        <div class="row">
                                            &nbsp;&nbsp;<img class="service-img"
                                                             src="{{asset('/images/icon/Service/Cucina.png')}}">
                                            ...
                                            @endif
                                            &nbsp;&nbsp;<img class="service-img"
                                                             src="{{asset('/images/icon/Service/Locale ricreativo.png')}}">
                                        ...
                                        <div class="row">
                                            @foreach(json_decode($annuncio[0]->servizi_offerti) as $service=>$value)
                                                &nbsp;&nbsp;<img class="service-img"
                                                                 src="{{asset('/images/icon/Service/'.$service.'.png')}}">
                                                @if($value!=null)
                                                    <span class="service">{{preg_replace('/_/', ' ', $service)}}</span>
                                                @else
                                                    <span
                                                        class="service_no">{{preg_replace('/_/', ' ', $service)}}</span>
                                                @endif
                                    ...
                                    @if('locatario'==(Auth::user()->tipo))
                                        <center>
                                            <div class="quote_btn-container">
                                                @if(empty($controllo))
                                                    <a class="quote_btn"
                                                       onclick="return confirm('Sicuro di voler prenotare questa locazione?')"
                                                       href="{{ route('prenota',['id_locatore'=>$annuncio[0]->id_locatore, 'id_locatario'=>Auth::user()->id, 'id_annuncio'=>$annuncio[0]->id_annuncio]) }}">
                                                        Prenota locazione
                                                    </a>
                                                    &nbsp;
                                                @else
                                                ...
                                                @endif
                                                <a class="quote_btn"
                                                   href="{{ route('chat',['id_locatore'=>$annuncio[0]->id_locatore, 'id_locatario'=>Auth::user()->id]) }}">
                                                    Contatta il locatore
                                                </a>
                                            </div>
                                            @elseif('Locatore'==(Auth::user()->tipo))
                                                <a class="quote_btn"
                                                   href="{{ route('richieste', ['id_annuncio'=>$annuncio[0]->id_annuncio]) }}">
