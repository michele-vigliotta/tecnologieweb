                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="box">
                                ...
                                <div class="detail-box">
                                    ...
                                    <label>Da {{date('d-m-Y', strtotime($annuncio->inizio_locazione))}}
                                        a {{date('d-m-Y', strtotime($annuncio->fine_locazione))}}</label>
                                    <p>
                                ...
                                <center>
                                    <div class="quote_btn-container">
                                        <a class="quote_btn"
                                           href="{{route('annuncioedit',['id'=>$annuncio->id_annuncio])}}">Modifica
                                            annuncio</a>
                                        &nbsp;
                                        <a class="quote_btn"
                                           href="{{route('annunciodelete',['id'=>$annuncio->id_annuncio])}}">Elimina
                                            annuncio</a>
                                    </div>
                                </center>
                            </div>
